...
const eventoTeste = {
  ...
  tipoServico: 'Roteiro',
  dataServico: '2026-06-14', // Formato ISO para a função de calendário
  dataServicoExibicao: '14 de Junho de 2026', // Formato de exibição visual
  horaEncontro: '09:00',
  localEncontro: 'Lobby do Hotel Ritz-Carlton Kyoto',
  clienteNome: 'Família Silva (4 adultos)',
  duracaoTour: '8 Horas (Dia inteiro)',
  textos: [] // Sem observações
};
...
const corDestaque = '#89232D'; // Vermelho Heian Oficial (Exato da Logo)
    ...
    <div style="padding: 30px 35px; color: #333333; line-height: 1.6;">
      ...
      <div style="background-color: #fafafa; border-left: 4px solid ${corDestaque}; padding: 18px; border-radius: 4px; margin: 20px 0; border-top: 1px solid #f0f0f0; border-right: 1px solid #f0f0f0; border-bottom: 1px solid #f0f0f0;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            ...
            <td style="padding: 6px 0; font-weight: bold; color: #1a1a1a; font-size: 14px;">${eventoTeste.dataServicoExibicao}</td>
          </tr>
          <tr>
            <td style="padding: 6px 0; font-weight: 600; color: #666; font-size: 14px;">Hora Encontro:</td>
            <td style="padding: 6px 0; font-weight: bold; color: ${corDestaque}; font-size: 14px;">${eventoTeste.horaEncontro}</td>
          </tr>
          <tr>
      ...
      <div style="margin: 20px 0; border-top: 1px solid #eee; padding-top: 15px;">
        ...
        <div style="font-size: 14px; color: #444;">
          <p style="margin: 5px 0;"><strong>Duração Estimada:</strong> Tour de ${eventoTeste.duracaoTour}</p>
        </div>
      </div>
