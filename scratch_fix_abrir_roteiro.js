...
const oldCode = `      if (orc.orcRoteiroVinculado) {
         ...
         btnRoteiro.onclick = () => { closeClienteModal(); abrirOrcamento(orc.id); document.getElementById('orcRoteiroVinculado').value = orc.orcRoteiroVinculado; navToPage('roteiros'); };
      } else {`;
...
console.log('Fixed Abrir Roteiro button in Cliente modal');
