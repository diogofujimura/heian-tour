...
const newLogic = `document.getElementById('btnGerarRoteiro').addEventListener('click', () => {
    ...
    // Em modo de visualização, os dados do cliente estão em dbRotas[nome].cliente
    // Em modo de edição, usamos o roteiroEmEdicao
    let cliente = {};
    if (typeof roteiroEmEdicao !== 'undefined' && roteiroEmEdicao.cliente && Object.keys(roteiroEmEdicao.cliente).length > 0) {
...
console.log('Fixed btnGerarRoteiro preview block.');
